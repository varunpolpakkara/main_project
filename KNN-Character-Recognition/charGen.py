...
def main():
    ...
    #imageContours, npaContours, npaHierarchy = cv2.findContours(imageThreshCopy,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
 
    _, npaContours, npaHierarchy = cv2.findContours(imageThreshCopy,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
